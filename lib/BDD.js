...
var BDD = (() => {
    ...
    BDD.prototype.not        = function ()      { notCalls++; return this.ite(False, True)      };
    BDD.prototype.and        = function (p)     { andCalls++; return this.ite(p, False)         };
    ...
    return {
        ...
        stats: function () {
            return {
                ...
                eqvCalls:   eqvCalls,
                xorCalls:   xorCalls,
                iteCalls:   Object.assign({ ttl: Object.keys(iteCalls).reduce((acc, k) => acc + iteCalls[k], 0) }, iteCalls),
                sizeCalls:  sizeCalls,
                /*
