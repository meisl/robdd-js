...
Program.prototype.traverse = function (onInstr, onEnd) {
    ...
    this.run((targetSlot, label, thenSlot, elseSlot) => {
        ...
        onInstr(maxLen, info, newTargetSlot, reusableNow);
...
Program.prototype.optimize = function () {
    this.traverse(
        /* onInstr: */ (maxLen, info, newTargetSlot, reusable) => { info.slot = newTargetSlot; },  // change target slot (if different); subsequent occurrences are fixed in the setter
