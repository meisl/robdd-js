...
/*
        ...
        values: { value: function*()   { for (let x of Object.keys(this)) { yield +x } },   enumerable: false, writable: false },
...
*/
    ...
    this.run((targetSlot, label, thenSlot, elseSlot) => {
        ...
        newTargetSlot = chooseTarget(maxLen, info, reusableNow);
...
Program.prototype.optimize = function () {
    this.traverse(
        /* chooseTarget: */ (maxLen, info, reusable)      => reusable.size === 0 ? maxLen : Math.max(...reusable),   //  Math.min(maxLen, ...reusable),  //
...
Program.prototype.toString = function () {
    ...
    this.traverse(
        /* chooseTarget: */ (maxLen, info, reusable) => {
            ...
            usableStr = util.inspect(reusable);
