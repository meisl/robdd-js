...
Object.defineProperties(InfoEntry.prototype, {
    ...
    swapped: {
        get: function () {
            ...
            let _swapped = Object.freeze( // let's freeze it to enforce that every write to it actually happens on *this*
                Object.create(this, {
                    // isFlipped and flipped taken from prototype, ie. *this*
    ...
    flipped: {
        get: function () {
            ...
            let _flipped = Object.freeze( // let's freeze it to enforce that every write to it actually happens on *this*
                Object.create(this, {
                    // isSwapped and swapped taken from prototype, ie. *this*
