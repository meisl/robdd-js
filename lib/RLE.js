...
function RLE() {
    let privateThis = Object.create(this, {
            ...
            _lastValue:     { value: undefined, writable: true  },
        });
...
function repeat(count, x) {
    return Object.create(null, {
        ...
        lastValue: { value: x,     enumerable: true                 },
...
function asIs() {
    return Object.create(null, {
        ...
        lastValue: { get:   function () { return this.values[this.count - 1];}, enumerable: true },
    });
}

RLE.prototype.addRepeat = function (count, value) {
    let code = repeat(count, value);
